...
angular.module('templates-workoutcalories', ['templates/workoutcalories.tpl.html']);

angular.module("templates/workoutcalories.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/workoutcalories.tpl.html",
    "<svg ng-attr-width=\"{{width}}\" ng-attr-height=\"{{height}}\"><g ng-attr-transform=\"translate({{margins.horizontal}}, {{margins.vertical}})\"><g ng-attr-transform=\"translate(0, {{height - 2 * margins.vertical}})\" class=\"x-axis\"></g><path ng-attr-d=\"{{caloriesPath}}\"></path></g></svg>");
}]);
